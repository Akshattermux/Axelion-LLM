...
class ModelConfig:
    ...
    @classmethod
    def create_micro(cls):
        """Debug model: CPU-friendly."""
        return cls(
            vocab_size=50257,
            max_seq_len=256,
            dim=256,
    ...
    def create_large(cls):
        """~1B-class architecture; training requires serious GPU infrastructure."""
        return cls(
            vocab_size=50257,
            max_seq_len=4096,
            dim=2048,
